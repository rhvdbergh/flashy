...
// this route only shows if the user is a student, otherwise
// it redirects to the home page

function ProtectedStudentRoute({ component, children, ...props }) {
  ...
  return (
    ...
    >
      {user.id && user.role === 'student' ? (
        ...
        <ProtectedComponent />
      ) : user.id ? ( // the user must be a teacher, redirect to the home page
        <Redirect to="/home" />
      ) : (
