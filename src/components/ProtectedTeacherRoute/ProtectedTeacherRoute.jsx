...
// this route only shows if the user is a teacher, otherwise
// it redirects to the home page

function ProtectedTeacherRoute({ component, children, ...props }) {
  ...
  return (
    ...
    >
      {user.id && user.role === 'teacher' ? (
        ...
        <ProtectedComponent />
      ) : user.id ? ( // the user must be a student, redirect to the home page
        <Redirect to="/home" />
      ) : (
